...
scene("game", () => {
    ...
    const bg1 = add([
        sprite("background"),
        pos(0, 0),
        scale(width() / 300, height() / 225), // Pas aan op je canvas grootte
    ]);

    const bg2 = add([
        sprite("background"),
        pos(width(), 0),
        scale(width() / 300, height() / 225),
    ]);
    ...
    const players = [
        ...
        { name: "chillguygame.png", x: 80, y: 40, scale: 0.15 },
        { name: "mangogame.webp", x: 80, y: 40, scale: 0.1 },
        { name: "johnporkgame.png", x: 80, y: 40, scale: 0.15 },
        { name: "pessigame.png", x: 80, y: 40, scale: 0.15 }
    ];
