...
scene("mainMenu", () => {
    add([text("Welcome to Chill Guy Jumper."), pos(width() / 2, height() / 4), anchor("center"), scale(2)]);
    add([text("Highscore: " + highscore), pos(width() / 2, height() / 2 - 95), scale(2), anchor("center")]);
    addButton("Start Game", vec2(width() / 2, height() / 2), () => go("game"));
